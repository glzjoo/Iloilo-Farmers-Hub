                        ...
                        <div key={i}>
                            ...
                            <div className="flex items-center justify-between mt-2">
                                ...
                                <div className="flex items-center gap-1">
                                    <button className="bg-transparent border-none cursor-pointer p-0" onClick={() => handleDecrement(i)}>
                                        <img src={minus} alt="Decrease" className="w-7 h-7" />
                                    </button>
                                    <span className="text-sm font-semibold text-gray-900 w-5 text-center">{counts[i]}</span>
                                    <button className="bg-transparent border-none cursor-pointer p-0" onClick={() => handleIncrement(i)}>
