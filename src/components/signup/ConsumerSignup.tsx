        ...
        <section className="flex items-center justify-center py-16 px-4">
            <div className="w-full max-w-3xl bg-white rounded-2xl shadow-lg p-10">
                ...
                <div className="grid grid-cols-2 gap-x-8 gap-y-5">
                    ...
                    <div>
                        <label className="block text-sm font-primary font-semibold text-gray-800 mb-1">Home Address</label>
                        <input
                            type="text"
                    ...
                    <div>
                        <label className="block text-sm font-primary font-semibold text-gray-800 mb-1">What do you want to buy?</label>
