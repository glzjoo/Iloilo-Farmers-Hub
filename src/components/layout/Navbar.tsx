                ...
                <div className="max-w-7xl mx-auto flex items-center justify-between px-6 pb-4 pt-1 gap-4">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                        ...
                        <Link to="/consumer-signup" className="no-underline">
                            <span className="text-accent font-heading text-base font-medium ml-1">Sign Up</span>
                        </Link>
                        <span className="text-accent font-heading text-base font-medium">|</span>
                        <Link to="/login" className="no-underline">
                            <span className="text-accent font-heading text-base font-medium">{t('login')}</span>
                        </Link>
                    </div>
                </div>
            </nav>
