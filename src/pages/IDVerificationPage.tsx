...
export default function IDVerificationPage() {
  ...
  return (
    <section className="flex items-center justify-center py-16 px-4 min-h-screen bg-gray-50">
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-lg p-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Please verify your identity to start selling on Iloilo Farmers Hub
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={isLoading || !idImage || !selfieImage}
